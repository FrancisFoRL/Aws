...
} elseif ($_instance->childHasBeenRendered('bwihxwy')) {
    $componentId = $_instance->getRenderedChildComponentId('bwihxwy');
    $componentTag = $_instance->getRenderedChildComponentTagName('bwihxwy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bwihxwy');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('bwihxwy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('IsTonV3')) {
    $componentId = $_instance->getRenderedChildComponentId('IsTonV3');
    $componentTag = $_instance->getRenderedChildComponentTagName('IsTonV3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IsTonV3');
} else {
    $response = \Livewire\Livewire::mount('profile.update-password-form');
    $html = $response->html();
    $_instance->logRenderedChild('IsTonV3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/profile/show.blade.php ENDPATH**/ ?>