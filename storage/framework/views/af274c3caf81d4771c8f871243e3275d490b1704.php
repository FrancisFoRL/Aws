<footer class="container-fluid p-5">
    ...
    <div class="text-center mt-2">
        <img src="<?php echo e(Storage::url('Logo.svg')); ?>" alt="El Rincón de las letras" width="70" height="70">
    ...
    <div class="mt-2 d-flex justify-content-center fs-5 pb-5 pb-lg-0 align-items-center" style="color:#D9D9D9;">
        <a href="<?php echo e(route('mapa')); ?>" class="text-decoration-none">
            <span>Mapa web</span>
        </a>
        <span class="mx-1 separator"> | </span>
        <a href="<?php echo e(route('info-legal')); ?>" class="text-decoration-none">
            <span>Información Legal</span>
        </a>
        <span class="mx-1 separator"> | </span>
        <a href="<?php echo e(route('privacidad')); ?>" class="text-decoration-none">
            <span>Política de privacidad</span>
        </a>
        <span class="mx-1 separator"> | </span>
        <a href="<?php echo e(route('contacto.show')); ?>" class="text-decoration-none">
            <span>Contacto</span>
        </a>
    </div>
</footer>
...
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/components/footer.blade.php ENDPATH**/ ?>