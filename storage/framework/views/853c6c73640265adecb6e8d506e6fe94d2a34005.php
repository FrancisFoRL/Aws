...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Sesiones Iniciadas')); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__('Si es necesario, puede cerrar todas sus sesiones de navegación en todos sus dispositivos. A continuación se enumeran algunas de sus sesiones recientes; sin embargo, esta lista puede no ser exhaustiva. Si cree que su cuenta se ha visto comprometida, actualice también su contraseña.')); ?>
                            ...
                            <div>
                                <div class="text-xs text-secondary">
                                    ...
                                    <?php if($session->is_current_device): ?>
                                        <span class="text-success fw-bold"><?php echo e(__('Este dispositivo')); ?></span>
                                    <?php else: ?>
                                        <?php echo e(__('Última dispositivo usado')); ?> <?php echo e($session->last_active); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('Cerrar todas las sesiones existentes')); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>