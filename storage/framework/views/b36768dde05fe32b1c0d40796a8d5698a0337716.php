            ...
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-6 g-2 g-md-4">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="<?php echo e(asset($book->image)); ?>" class="card-img-top" alt="...">
                        <div class="card-body pb-0 pt-2">
                            <h3 class="card-title book-title"><?php echo e($book->title); ?></h3>
                        </div>
                        <div class="card-footer p-2 align-items-center d-flex justify-content-between"
                            style="background-color: #212121">
                            <p class="card-text m-0 fw-bold"><?php echo e($book->price); ?>€</p>
                            <div class="d-flex ">
                                <form action="<?php echo e(route('cart.store')); ?>" method="POST">
                                    <input type="hidden" name="book_id" value="<?php echo e($book->id); ?>">
                                    <button type="submit" class="card-button p-2 px-3 me-1" title="Añadir al carrito">
                                        <i class="fa-solid fa-cart-plus"></i>
                                    </button>
                                </form>
                                <button class="card-button p-2 px-3" title="Mas información sobre el libro">
...
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/welcome.blade.php ENDPATH**/ ?>