    ...
    <script src="https://cdn.tailwindcss.com"></script>
     <?php $__env->slot('content', null, []); ?> 
        ...
        <h3 class="text-center mb-1 text-danger">
            ...
            <?php endif; ?>
            <?php else: ?>
            <?php echo e(__('No tienes activa la verificación en dos pasos')); ?>
        ...
        <div class="mt-3 text-center">
            <p>
                <?php echo e(__('Cuando la autenticación de dos factores está activada, se le pedirá un token seguro y aleatorio
        ...
        <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p class="font-semibold">
                <?php if($showingConfirmation): ?>
                <?php echo e(__('To finish enabling two factor authentication, scan the following QR code using your phone\'s
                authenticator application or enter the setup key and provide the generated OTP code.')); ?>

                <?php else: ?>
                <?php echo e(__('Two factor authentication is now enabled. Scan the following QR code using your phone\'s
...
<?php endif; ?>
        ...
        <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p class="font-semibold">
                <?php echo e(__('Store these recovery codes in a secure password manager. They can be used to recover access to
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>