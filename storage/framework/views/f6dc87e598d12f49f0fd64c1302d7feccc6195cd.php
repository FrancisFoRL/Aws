    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="">
            ...
            <ul class="navbar-nav ms-auto me-2 align-items-center">
                ...
                <?php if(url()->current() != url('/cart/cart-show')): ?>
                <li class="nav-item me-4">
...
} elseif ($_instance->childHasBeenRendered('l2189244209-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2189244209-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2189244209-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2189244209-0');
} else {
    $response = \Livewire\Livewire::mount('cart.cart-show-inicio');
    $html = $response->html();
    $_instance->logRenderedChild('l2189244209-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/livewire/navbar.blade.php ENDPATH**/ ?>