...
<div class="d-flex align-items-center p-3 rounded-pill flash-message mt-lg-3">
    ...
    <span class="mx-2 fw-bold" style="font-family: Roboto"><?php echo e(session()->get('success_message')); ?></span>
</div>
<?php endif; ?>
...
<div class="d-flex align-items-center p-3 rounded-pill flash-message mt-lg-3">
    <lottie-player src="https://assets10.lottiefiles.com/private_files/lf30_2putscqk.json" background="transparent"
        speed="1" style="width: 50px; height: 50px;" autoplay></lottie-player>
    <span class="mx-2 fw-bold" style="font-family: Roboto"><?php echo e(session()->get('wishlist')); ?></span>
</div>
<?php endif; ?>
...
<div class="d-flex align-items-center p-3 rounded-pill flash-message mt-lg-3">
    ...
    <span class="mx-2 fw-bold" style="font-family: Roboto"><?php echo e(session()->get('delete')); ?></span>
</div>
<?php endif; ?>

<?php if(session()->has('wishlist-error')): ?>
<div class="d-flex align-items-center p-3 rounded-pill flash-message mt-lg-3">
    <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_bdnjxekx.json" background="transparent" speed="1"
        style="width: 50px; height: 50px;" autoplay></lottie-player>
    <span class="mx-2 fw-bold" style="font-family: Roboto"><?php echo e(session()->get('wishlist-error')); ?></span>
</div>
<?php endif; ?>

<?php if(session()->has('email-error')): ?>
<div class="d-flex align-items-center p-3 rounded-pill flash-message mt-lg-3">
    <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_bdnjxekx.json" background="transparent" speed="1"
        style="width: 50px; height: 50px;" autoplay></lottie-player>
...
<?php if(session()->has('send-opinion')): ?>
<div class="d-flex align-items-center p-3 rounded-pill flash-message mt-lg-3">
    <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_YSMTHj.json" background="transparent"
        speed="1" style="width: 50px; height: 50px;" autoplay></lottie-player>
    <span class="mx-2 fw-bold" style="font-family: Roboto"><?php echo e(session()->get('send-opinion')); ?></span>
</div>
<?php endif; ?>
...
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/components/messages.blade.php ENDPATH**/ ?>