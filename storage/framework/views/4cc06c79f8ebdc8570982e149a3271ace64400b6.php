            ...
            <div id="form" class="w-50 p-4">
                ...
                <div>
                    ...
                    <form action="" class="mx-3">
                                ...
                                <div class="card-body p-0">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <input class="card-title w-100" placeholder="Número de tarjeta"></input>
                                        </div>
                                        ...
                                        <div class="col-2">
                                            <img src="<?php echo e(Storage::url('visa-logo.png')); ?>" alt="Icono de Tarjeta de Pago"
                                                width="100px">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group mt-5 justify-content-center" id="pagar-paypal">
                            <form action="<?php echo e(action([PaypalController::class, 'requestpayment'])); ?>" method="POST">
                            <input type="number" class="form-control visually-hidden" value="<?php echo e(Cart::subtotal()); ?>" name="amount">
                            <button class="btn btn-primary" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-paypal" viewBox="0 0 16 16">
...
<?php /**PATH /home/fran/public_html/elRinconDeLasLetras/resources/views/checkout/checkout.blade.php ENDPATH**/ ?>